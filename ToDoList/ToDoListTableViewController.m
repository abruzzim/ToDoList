...
- (IBAction)unwindToList:(UIStoryboardSegue *)segue {
    ...
    AddToDoItemViewController *source = [segue sourceViewController]; // Retrieve the source view controller.
    ToDoItem *item = source.toDoItem;                                 // Retrieve the value of the controller's "toDoItem" property.
